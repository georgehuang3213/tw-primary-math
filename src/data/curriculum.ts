...
export const CURRICULUM_UNITS: Unit[] = [
  ...
  // =========================================================================
  {
    ...
    keyConcepts: ['1~10點數', '數字讀寫', '比多少與一一對應'],
    learningGoals: [
      '能正確點數 1~10 的具體物件並寫出數字',
      '能用一一對應比較兩群物體的多少',
      '理解 0 代表沒有東西的概念'
    ],
    story: {
      ...
      dialogue: '獅子隊長說：「請大家排好隊，數數看草地上一共有幾隻小動物？」',
      task: '動手點數草地上的小動物，練習從 1 數到 10！'
    },
    rhyme: {
      title: '數字兒歌',
      lines: [
    ...
    lessonSteps: [
      {
        stepNum: 1,
        stepTitle: '手指點數不重複',
        stepDesc: '用手指指著物品，一邊指一邊數「1、2、3...」，數到的最後一個數字就是總數。'
      },
      {
        stepNum: 2,
        stepTitle: '一一對應比多少',
        stepDesc: '把小狗和小骨頭一對一連線，有剩下沒連到的一邊就是比較多。'
      }
    ],
    warmup: {
      question: '盤子裡有 6 顆蘋果，再放進 0 顆蘋果，盤子裡現在有幾顆蘋果？',
      options: ['6 顆', '0 顆', '7 顆'],
      answerIndex: 0,
      explanation: '0 代表沒有增加，所以依然是 6 顆蘋果！'
    }
  },
  {
